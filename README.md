...
The option price effect folder examines the option price sensitivity to changes in those parameters. There is an excel file that graphs these results out into a readable format. As of April 3, 2023, I plan to have my thoughts on the graphs within the next month.
